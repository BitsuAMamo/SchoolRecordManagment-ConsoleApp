...
void insertFacultyRecord(Faculty faculties[]) {
  ...
  for (int i = index; i < INDEX[0]; ++i) {
    cout << "+-------------------------------------------------------+" << endl;
    cout << setw(19) << "| Employee Number: " << setw(3) << i + 1 << setw(35)
         << right << " |" << endl;
    cout << "+-------------------------------------------------------+" << endl;
    cout << "| First Name => ";
...
void insertStudentRecord(Student students[]) {
  ...
  for (int i = index; i < INDEX[1]; ++i) {
    cout << "+-------------------------------------------------------+" << endl;
    cout << setw(19) << "| Student Number: " << setw(3) << i + 1 << setw(35)
         << right << " |" << endl;
    cout << "+-------------------------------------------------------+" << endl;
    cout << "| First Name => ";
...
void editFacultyRecord(Faculty faculties[], int index) {
  ...
  if (index > 0 && index < INDEX[0] + 1) {
    ...
    cout << "+-----------------------EDIT----------------------------+" << endl;
    cout << "+-------------------------------------------------------+" << endl;
    cout << setw(19) << "| Employee Number: " << setw(3) << index + 1
         << setw(35) << right << " |" << endl;
    cout << "+-------------------------------------------------------+" << endl;
    cout << "| First Name => ";
...
void editStudentRecord(Student students[], int index) {
  ...
  if (index > 0 && INDEX[1] + 1) {
    ...
    cout << "+-----------------------EDIT----------------------------+" << endl;
    cout << "+-------------------------------------------------------+" << endl;
    cout << setw(19) << "| Student Number: " << setw(3) << index + 1 << setw(35)
         << right << " |" << endl;
    cout << "+-------------------------------------------------------+" << endl;
    cout << "| First Name => ";
...
void printFacultyRecords(Faculty faculties[], int index) {
  if (index > 0) {
    ...
    for (int i = 0; i < index; ++i) {
      ...
      name =
          (string)faculties[i].firstName + " " + (string)faculties[i].lastName;
      cout << "|" << setw(4) << i + 1 << "|";
      cout << setw(42) << name << "|";
...
void printDate(Date day) {
  cout << setw(2) << day.day << "/" << setw(2) << day.month << "/" << setw(4)
       << day.year << "|";
}

void printAddress(Address address) {
  cout << setw(9) << address.houseNum << "|" << setw(6) << address.woreda << "|"
       << setw(4) << address.city << "|";
}
...
void searchRecords(Student students[]) {
  ...
  case 1:
    ...
    cin >> target_char;
    for (int i = 0; i < INDEX[1]; ++i) {
      if (!strcmpi(target_char, students[i].firstName) ||
          !strcmpi(target_char, students[i].lastName)) {
  ...
  case 2:
    ...
    cin >> target_char;
    for (int i = 0; i < INDEX[1]; ++i) {
      if (!strcmpi(target_char, students[i].grade) ||
          !strcmpi(target_char, students[i].grade)) {
        results[counter] = students[i];
        counter++;
      }
    }
  ...
  case 3:
    ...
    cin >> target_char;
    for (int i = 0; i < INDEX[1]; ++i) {
      if (!strcmpi(target_char, students[i].section) ||
          !strcmpi(target_char, students[i].section)) {
        results[counter] = students[i];
        counter++;
      }
    }
...
void searchRecords(Faculty faculties[]) {
  ...
  case 1:
    ...
    cin >> target_char;
    for (int i = 0; i < INDEX[0]; ++i) {
      if (!strcmpi(target_char, faculties[i].firstName) ||
          !strcmpi(target_char, faculties[i].lastName)) {
...
void subMenu(int n) {
  ...
  cout << setw(10) << left << "+----+--" << setw(6) << values[n - 1] << setw(4)
       << " Menu" << setw(9) << "--------+" << endl;
  cout << setw(6) << "| 0. |" << setw(20) << "Go Back " << setw(4) << right
       << "|" << endl;
  cout << setw(6) << "| 1. |" << setw(6) << values[n - 1] << setw(18)
       << " Faculty Records |" << endl;
  cout << setw(6) << "| 2. |" << setw(6) << values[n - 1] << setw(18)
...
void mainMenu() {
  ...
  cout << setw(22) << left << "| 0. | Exit "
       << "|" << endl;
  cout << setw(22) << "| 1. | Add to Record "
       << "|" << endl;
  cout << setw(22) << "| 2. | Edit Record "
       << "|" << endl;
  cout << setw(22) << "| 3. | Delete Record "
       << "|" << endl;
  cout << setw(22) << "| 4. | Print Record "
       << "|" << endl;
  cout << setw(22) << "| 5. | Search Record "
       << "|" << endl;
  cout << setw(22) << "+----+----------------+" << endl;
  cout << setw(12) << "| Input =>  ";
}
